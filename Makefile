...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = client$(EXEEXT) sp$(EXEEXT)
...
client_LINK = $(CXXLD) $(AM_CXXFLAGS) $(CXXFLAGS) $(client_LDFLAGS) \
	$(LDFLAGS) -o $@
am__sp_SOURCES_DIST = sp.cpp agent_wget.cpp iasrequest.cpp byteorder.c \
...
am__v_CXXLD_1 = 
SOURCES = $(client_SOURCES) $(nodist_client_SOURCES) $(sp_SOURCES)
DIST_SOURCES = $(client_SOURCES) $(am__sp_SOURCES_DIST)
...
ACLOCAL = ${SHELL} /home/alex/sgx-ra-sample/missing aclocal-1.15
AGENT_CURL_SRC = agent_curl.cpp
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/alex/sgx-ra-sample/missing autoconf
AUTOHEADER = ${SHELL} /home/alex/sgx-ra-sample/missing autoheader
AUTOMAKE = ${SHELL} /home/alex/sgx-ra-sample/missing automake-1.15
AWK = mawk
CC = gcc
...
LIBS_HW_SIMU = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/alex/sgx-ra-sample/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
...
RANLIB = ranlib
SET_MAKE = 
SGXSDK = /home/alex/sgx-step/linux-sgx/linux/installer/bin/sgxsdk
SGXSDK_BINDIR = /home/alex/sgx-step/linux-sgx/linux/installer/bin/sgxsdk/bin/x64
SGXSDK_INCDIR = /home/alex/sgx-step/linux-sgx/linux/installer/bin/sgxsdk/include
SGXSDK_LIBDIR = /home/alex/sgx-step/linux-sgx/linux/installer/bin/sgxsdk/lib64
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/alex/sgx-ra-sample
abs_srcdir = /home/alex/sgx-ra-sample
abs_top_builddir = /home/alex/sgx-ra-sample
abs_top_srcdir = /home/alex/sgx-ra-sample
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/alex/sgx-ra-sample/install-sh
